    ...
    : AARCH64PlatformMemoryManager(memory_model)
{
    ...
    kernel_page_table_[0] = (0x8000000000000000) | KernelVirtualAddressToPhysical((uintptr_t)&Stage2map1to1_[0]) | 3;
    kernel_page_table_[1] = (0x8000000000000000) | KernelVirtualAddressToPhysical((uintptr_t)&Stage2map1to1_[512]) | 3;
